...
class Engine {
	...
	/* getFoundPage() gets the found page in the found folder. The found page in the found folder never changes. 
	
	By contrast, the current page in the found folder may be changed be calling methods in the folder class. This is typically done in templates and widgets. To get the current page, call getFoundFolderCurrentPage() which is implemented below. */

	public static function getFoundPage() {
		return self::$foundPage;
	}

	public static function getFoundFolderCurrentPage() {
